...
function App() {
  ...
  const [cVal1, setCVal1] = useState<number>(10)
  ...
  const findRoute = async () => {
    ...
    try {
      ...
      setResults({ r1, r2 })
    } catch (e) { console.error("Find route failed:", e) } finally { setLoading(false) }
  }
  ...
  const applyProject = (p: Project) => {
    ...
    if (p.method === 'constrained') {
      ...
      setCVal1(p.constraint_value || 10)
    }
              ...
              <div className="constraint-box">
                ...
                <div style={{ display: 'flex', gap: '15px' }}>
                  <select className="input-field" value={cType1} onChange={(e) => setCType1(e.target.value)}>
                    ...
                    <option value="cost">Cost Limit (units)</option>
                  </select>
              ...
              <FadeInSection>
                <div className="result-card">
                  ...
                  <div className="result-summary">
                     <div className="stat"><DollarSign size={18}/> {results.r1.total_cost} <span>units</span></div>
                    ...
                    <div className="steps-list-box">
                      ...
                      {(results.r1.details || []).map((step, i) => (
                        <div key={i} className="route-step">
                          ...
                          <div className="step-meta">Impact: {step.cost} | Duration: {step.time}h</div>
                        </div>
                      ))}
                    </div>
              ...
              <FadeInSection>
                <div className="result-card secondary">
                  ...
                  <div className="result-summary secondary">
                     <div className="stat"><DollarSign size={18}/> {results.r2.total_cost} <span>units</span></div>
